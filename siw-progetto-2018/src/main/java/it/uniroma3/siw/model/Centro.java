...
public class Centro {
	...
	public Centro(Long id, String nome, String email, String telefono, int numeroMaxAllievi, 
		...
		this.numeroMaxAllievi = numeroMaxAllievi;
	...
	public int getNumeroMaxAllievi() {
		return numeroMaxAllievi;
	}

	public void setNumeroMaxAllievi(int numeroMaxAllievi) {
		this.numeroMaxAllievi = numeroMaxAllievi;
	}
	...
	public int hashCode() {
		...
		result = prime * result + numeroMaxAllievi;
	...
	public boolean equals(Object obj) {
		...
		if (numeroMaxAllievi != other.numeroMaxAllievi) {
			return false;
		}
		if (telefono == null) {
